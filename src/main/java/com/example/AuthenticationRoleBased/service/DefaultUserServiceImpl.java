...
import com.example.AuthenticationRoleBased.model.Role;
import com.example.AuthenticationRoleBased.model.User;
import com.example.AuthenticationRoleBased.repository.RoleRepository;
import com.example.AuthenticationRoleBased.repository.UserRepository;
...
public class DefaultUserServiceImpl implements DefaultUserService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        if (user == null) {
            throw new UsernameNotFoundException("Սխալ մուտքանուն կամ գաղտնաբառ:");
        } else {
